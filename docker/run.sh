...
function show_help() {
  ...
  Options:\n
  \t-i --image_name\t\t Name of the image to be run (default ros_melodic).\n
  \t-c --container_name\t Name of the container(default ros_melodic_container).\n
...
IMAGE_NAME=${IMAGE_NAME:-ros_melodic}
CONTAINER_NAME=${CONTAINER_NAME:-ros_melodic_container}
